...
| `infobox` | Fandom-style infobox rendered from a JSON data object: titled sections, label/value rows, tabbed images with contain/cover fit, and an optional accent color |
